...
<?php foreach ($articles as $article) : ?>
    <article id="article<?= $article->getIdArticle() ?>">
        ...
        <a href="<?= sprintf("/article/show/%d", $article->getIdArticle()) ?>">Display article</a>
        <?php if (isset($_SESSION['user'])) : ?>
            <a href="<?= sprintf("/article/edit/%d", $article->getIdArticle()) ?>">Edit article</a>
            <a href="<?= sprintf("/article/delete/%d", $article->getIdArticle()) ?>">Delete article</a>
        <?php endif; ?>
    </article>
<?php endforeach; ?>
